...
namespace LabyrinthGame
{
	...
	Maze::Maze(std::vector<MazePiece> const& pieces_)
		...
		_pieces(pieces_),
		_piece_placement(),
		_is_fixed(NUM_COORDINATES, false)
	{
	...
	void Maze::insertMazePieceOnTheLeft(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType y)
	{
	...
	void Maze::insertMazePieceOnTheRight(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType y)
	{
		CoordType const sparePieceTemp = _piece_placement[NUM_COORDINATES + _spare_piece_id];
		_piece_placement[NUM_COORDINATES + _spare_piece_id] =
			_piece_placement[Utils::compute1DFrom2D({ 0, y })];
	...
	void Maze::insertMazePieceAtTheTop(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType x)
	{
		CoordType const tmp = _piece_placement[NUM_COORDINATES + _spare_piece_id];
		_piece_placement[NUM_COORDINATES + _spare_piece_id] =
			_piece_placement[Utils::compute1DFrom2D({ x, HEIGHT - 1 })];
	...
	void Maze::insertMazePieceAtTheBottom(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType x)
	{
		CoordType const tmp = _piece_placement[NUM_COORDINATES + _spare_piece_id];
		_piece_placement[NUM_COORDINATES + _spare_piece_id] =
			_piece_placement[Utils::compute1DFrom2D({ x,0 })];
