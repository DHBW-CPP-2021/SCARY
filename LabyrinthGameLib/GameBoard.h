...
namespace LabyrinthGame {
	...
	public:
		 ...
		 */
		[[maybe_unused ]] void insertSparePieceInRow(GameSettings::CoordType y, Geo::Direction direction, GameSettings::CoordType spare_piece_id);
		 ...
		 * @param _spare_piece_id ID of the spare piece
		 */
		[[maybe_unused ]] void insertSparePieceInColumn(GameSettings::CoordType x, Geo::Direction direction, GameSettings::CoordType spare_piece_id);
	...
	private:
		...
		[[nodiscard]] static inline Logger const& LOG() { return _logger; }
