...
namespace LabyrinthGame
{
	...
	private:
		...
		void insertMazePieceOnTheLeft(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType y);
		void insertMazePieceOnTheRight(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType y);
		void insertMazePieceAtTheTop(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType x);
		void insertMazePieceAtTheBottom(LabyrinthGame::GameSettings::CoordType _spare_piece_id, LabyrinthGame::GameSettings::CoordType x);
