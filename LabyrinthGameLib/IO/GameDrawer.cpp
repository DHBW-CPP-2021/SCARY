...
namespace LabyrinthGame
{
	namespace IO
	{
		...
		GameDrawer::PreparedStrings::PreparedStrings() :
			_upper_lower_wall(GameDrawer::innerWidth(), '-'),
			_upper_lower_fixed_wall(GameDrawer::innerWidth(), '*'),
			_upper_lower_free(GameDrawer::innerWidth(), ' '),
			_left_right_wall(GameDrawer::wallWidth(), '|'),
			_left_right_fixed_wall(GameDrawer::wallWidth(), '*'),
			_left_right_free(GameDrawer::wallWidth(), ' '),
		...
		GameDrawer::IO::IO(std::ostream& out, GameSettings::CoordType whitespace_between_columns_,
			...
			out(out),
			whitespace_between_columns(whitespace_between_columns_),
